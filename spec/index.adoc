...
In addition, for Coding values, equivalence is defined in terms of the code and system elements only, display and version are ignored for the purposes of determining equivalence.
