...
[source]
----
SimpleTypeInfo { modelName: string, name: string, baseType: TypeSpecifier }
----
...
ClassInfo { modelName: string, name: string, baseType: TypeSpecifier, element: List<ClassInfoElement> }
----
