...
=== URI and Media Types
To uniquely identify the FluentPath language, the following URI is defined:

http://hl7.org/fluentpath

In addition, a media type is defined to support describing FluentPath content:
