...
If the result of evaluating the condition is other than a single boolean value, an error is raised, consistent with singleton evaluation of collections behavior.
...
If specified, the number of digits of precision must be >= 0 or an error is raised.
